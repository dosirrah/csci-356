...
__radd__ is used when the type of the left-hand-side of an addition operator does not have
a defined addition operator OR it has an addition operator but its addition operator
does not know how to handle the type of the right-hand side.  For eample, consider
