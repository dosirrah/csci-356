...
Above, the Python shell calls __repr__ on the Fraction class which returns the string "1/2".

__repr__ may be used in other contexts such as by a debugger to provide
a representation of an object suitable for inspection.  The output should be
sufficiently detailed to reproduce the object (e.g., with serialization).
...
class Fraction:  # from Listing 1
    ...
    def __repr__(self):
        """:return: string form of the Fraction.  Fraction(1, 2) becomes "1/2".
        """
